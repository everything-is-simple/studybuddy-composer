# Component Card: asr-funasr

- Gate: B0 candidate intake; this card is not an approval.
- Capability: `asr`
- Kind: `speech-to-text`
- Source: https://github.com/modelscope/FunASR; upstream/version/license requires verification
...
- Independent smoke command: `python components/asr-funasr/smoke.py`
