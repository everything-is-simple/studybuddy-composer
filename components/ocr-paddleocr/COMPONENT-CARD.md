...
- Capability: `ocr`
- Kind: `image-to-text`
- Source: https://github.com/PaddlePaddle/PaddleOCR; upstream/version/license requires verification
...
- Notes: Candidate only. Model download and runtime network behavior must be independently verified.
